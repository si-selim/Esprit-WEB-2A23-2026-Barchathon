...
<aside class="sidebar">
    ...
    <nav class="side-nav">
        ...
        <a class="side-link <?php echo $activeTab==='parcours'?'active':''; ?>" href="dashboard.php?tab=parcours">Parcours</a>
                        ...
                        <td>
                            <div class="table-actions">
                                <a class="btn btn-danger btn-sm"
                                   ...
                                   onclick="return confirm('Supprimer ce marathon ?')">Supprimer</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; endif; ?>
                        ...
                        <td>
                            <div class="table-actions">
                                <a class="btn btn-danger btn-sm"
                                   ...
                                   onclick="return confirm('Supprimer ce parcours ?')">Supprimer</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; endif; ?>
