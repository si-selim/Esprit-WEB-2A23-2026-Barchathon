...
<body>
    <header class="site-header">
        <div class="container">
            ...
            <nav class="nav">
                <a href="../../../BackOffice/dashboard.php">Accueil</a>
    ...
    <div class="stand">
        ...
        <!-- CATEGORIE 1 -->
        <h2 class="category-title">Stand-Trail de Zaghouan</h2>
        <div class="grid-stands">
            <div class="card">
                <div class="card-head">
                    <h3>🏪 Stand Outdoor</h3>
                    <div class="stand-position"><span class="pin-icon">📍</span> Position : Equipement</div>
                </div>
                <div class="card-body">
                    <p class="stand-desc">Accessoires trail et montagne.</p>
                    <div class="card-buttons">
                        <a class="btn-catalogue" href="produitC3.php">🛒 Voir catalogue produits</a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const idParcours = 4; // Trail de Zaghouan
