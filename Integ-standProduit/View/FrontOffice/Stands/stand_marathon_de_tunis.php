...
<body>
    ...
    <div class="stand">
        ...
        <!-- CATEGORIE 1 -->
        <h2 class="category-title">stand-marathon de tunis</h2>
        <div class="grid-stands">
            <div class="card">
                <div class="card-head">
                    <h3>🏪 Stand hydratation</h3>
                    <div class="stand-position"><span class="pin-icon">📍</span> Position : Boissons</div>
                </div>
                <div class="card-body">
                    <p class="stand-desc">Boissons isotoniques, eau et packs energie.</p>
                    <div class="card-buttons">
                        <a class="btn-catalogue" href="produitC1.php">🛒 Voir catalogue produits</a>
            ...
            <div class="card">
                <div class="card-head">
                    <h3>🏪 Stand souvenir</h3>
                    <div class="stand-position"><span class="pin-icon">📍</span> Position : Textile</div>
                </div>
                <div class="card-body">
                    <p class="stand-desc">Produits souvenirs et vetements finisher.</p>
                    <div class="card-buttons">
                        <a class="btn-catalogue" href="produitC1souvenir.php">🛒 Voir catalogue produits</a>
                        <a class="btn-manipuler" href="crud-stand.php">⚙️ Manipuler Stand</a>
                    </div>
                </div>
            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const idParcours = 1; // Marathon de Tunis Medina
