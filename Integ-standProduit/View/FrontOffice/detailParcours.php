...
<div class="page">
    ...
    <div style="display:flex;gap:12px;margin-bottom:20px;flex-wrap:wrap;justify-content:flex-end;">
        <a href="crud-stand.php?parcours_id=<?php echo $id; ?>" class="btn btn-primary" style="padding:11px 20px;"><i class="fa-solid fa-plus"></i> Ajouter un stand</a>
    </div>
    <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <div class="p-card stand-card-item">
                ...
                <div class="p-actions" style="padding:12px 16px;border-top:1px solid #e5e7eb;display:flex;gap:8px;">
                    ...
                    <a href="Stands/deleteStand.php?id=<?php echo $standId; ?>" class="btn-del-card" style="flex:1;padding:9px 8px;" onclick="return confirm('Voulez-vous vraiment supprimer ce stand ?')"><i class="fa-solid fa-trash"></i> Supprimer</a>
                </div>
                <?php endif; ?>
            </div>
            <?php endforeach; ?>
