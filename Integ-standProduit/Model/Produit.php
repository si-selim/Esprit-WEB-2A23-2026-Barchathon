...
class Produit {
        ...
        try {
            if ($this->ID_produit === null) {
                ...
                if ($this->image !== null) {
                    $stmt = $pdo->prepare("
                        UPDATE produit 
                        SET ID_stand=?, nom_produit=?, type=?, prix_produit=?, qte_stock=?, en_out_stock=?, image=?
                        WHERE ID_produit=?
                    ");
                    $stmt->execute([
                        $this->ID_stand,
    ...
    public function getEnOutStock(): ?string { return $this->en_out_stock; }
    ...
    public function setEnOutStock(?string $v) { $this->en_out_stock = $v; }
