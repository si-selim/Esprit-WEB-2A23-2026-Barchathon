...
// Comptes demo
$comptes = [
    'admin'        => ['password' => 'admin',        'role' => 'admin',        'nom' => 'Admin'],
    'organisateur' => ['password' => 'organisateur', 'role' => 'organisateur', 'nom' => 'Organisateur Demo'],
    'participant'  => ['password' => 'participant',  'role' => 'participant',  'nom' => 'Participant Demo'],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($comptes[$username]) && $comptes[$username]['password'] === $password) {
        $_SESSION['user'] = [
            'username' => $username,
            'nom'      => $comptes[$username]['nom'],
            'role'     => $comptes[$username]['role'],
        ];
