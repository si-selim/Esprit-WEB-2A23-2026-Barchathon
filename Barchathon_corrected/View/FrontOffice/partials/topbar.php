    ...
    <div class="fo-topbar-shell">
        ...
        <nav class="fo-nav">
            ...
            <?php if ($role === 'visiteur'): ?>
                <a class="fo-link" href="#">S'inscrire</a>
                <a class="fo-cta" href="login.php">Se connecter</a>

            <?php elseif ($role === 'participant'): ?>
                <a class="fo-link" href="#">Voir mes commandes</a>
            ...
            <?php elseif ($role === 'organisateur'): ?>
                <a class="fo-link" href="#">Voir mes commandes</a>
                <a class="fo-link" href="../BackOffice/marathon/listMarathons.php">Mes marathons</a>
                <span class="fo-user"><?php echo htmlspecialchars($user['nom']); ?> <span class="fo-role-badge">organisateur</span></span>
                <a class="fo-link" href="logout.php">Se déconnecter</a>

            <?php elseif ($role === 'admin'): ?>
                <a class="fo-link" href="dashboard.php">Dashboard</a>
